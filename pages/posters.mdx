...
Please submit your project via this google form: https://forms.gle/vfYHKNLkTyTvUwJVA, and bring your poster (preferred size: A1). It can be printed via [Tartan Ink](https://www.cmu.edu/tartanink/) or [SCS Poster Printing](https://computing.cs.cmu.edu/desktop/printing-posters) if you are part of SCS community. If for some reason you are unable to print the poster, please email us notifying this!
